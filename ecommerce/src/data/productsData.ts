...
export const PRODUCTS_DATA: Product[] = [
  ...
  {
    id: "NexGen-advanced-regrowth-kit",
    name: "NexGen Advanced Hair Regrowth Kit for Men | 4-Step Routine with Max Cyclical Hair Therapy",
    slug: "NexGen-advanced-hair-regrowth-kit-men",
    category: "Kits & Combos",
    concern: "Regrowth",
    price: 3607,
    rating: 4.8,
  ...
  {
    id: "NexGen-daily-kit",
    name: "NexGen Daily Kit | Everyday Hair Care for Men and Women",
    slug: "NexGen-daily-hair-care-kit",
    category: "Kits & Combos",
  ...
  },
  {
    ...
    name: "NexGen Clinical DHT Blocker Scalp Cleanser & Shampoo",
    slug: "NexGen-clinical-dht-blocker-shampoo",
    category: "Shampoos",
    concern: "Hair Fall",
    price: 899,
    originalPrice: 1099,
  ...
  {
    id: "cyclical-tablets",
    name: "NexGen Cyclical Vitamin & DHT Blocker Tablets (60 Caps)",
    slug: "NexGen-cyclical-vitamin-dht-blocker-tablets",
  ...
  },
  {
    ...
    name: "NexGen 5% Redensyl + 3% Procapil Hair Growth Serum (50ml)",
    slug: "NexGen-redensyl-procapil-hair-growth-serum",
  ...
  },
  {
    ...
    name: "NexGen Titanium 0.5mm Scalp Micro-Needling Derma Roller",
    slug: "NexGen-micro-needling-derma-roller",
    category: "Devices",
    concern: "Regrowth",
    price: 699,
    rating: 4.7,
  ...
  },
  {
    ...
    name: "NexGen Scalp Relief Anti-Dandruff & Flake Control Lotion",
    slug: "NexGen-anti-dandruff-flake-control-lotion",
    category: "Topical Solutions",
    concern: "Dandruff",
    price: 799,
    rating: 4.6,
