      ...
      <div className="qht-large-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-5">
            ...
            <div className="space-y-4 text-xs sm:text-sm text-gray-600 leading-relaxed font-normal max-w-2xl pt-2">
              <p>
          ...
          <div className="lg:col-span-5 divide-y divide-gray-200 border-t border-b border-gray-200">
            {JOURNEY_PILLARS.map((pillar, idx) => (
              <div key={idx} className="py-5 sm:py-6 flex items-start gap-4">
                <span className="text-xs sm:text-sm font-bold text-nexgen-primaryGold tracking-tight flex-shrink-0 pt-0.5 select-none">
                  {pillar.num}
                </span>
                <div>
                  <h3 className="text-sm sm:text-base font-[500] text-nexgen-veryDarkHeader mb-1">
                    {pillar.title}
                  </h3>
        ...
        {/* <div className="rounded-2xl border border-nexgen-primaryGold/20 p-4 sm:p-5 flex items-center gap-3.5 bg-white shadow-2xs hover:border-nexgen-primaryGold/40 hover:shadow-xs transition-all">
              ...
              <div>
                <h4 className="text-xs sm:text-[13px] font-bold text-nexgen-veryDarkHeader leading-snug">
                  US-FDA-approved <br />
                  technology
                </h4>
              </div>
