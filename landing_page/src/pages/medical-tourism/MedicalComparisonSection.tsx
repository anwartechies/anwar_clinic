    ...
    <section className="py-20 lg:py-24 bg-white overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-nexgen-veryDarkHeader tracking-tight leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
          ...
          <div className="bg-nexgen-pageLightBg rounded-3xl p-6 sm:p-8 flex flex-col justify-between border border-gray-200">
            {/* Header */}
            ...
            <div className="divide-y divide-gray-200/70 flex-1 flex flex-col justify-around">
              {COMPARISON_ROWS.map((row, idx) => (
                <div
                  key={idx}
                  className="py-5 sm:py-6 text-sm sm:text-base font-semibold text-nexgen-veryDarkHeader flex items-center"
                >
                  {row.feature}
                </div>
              ))}
          ...
          <div className="bg-nexgen-pageLightBg rounded-3xl p-6 sm:p-8 flex flex-col justify-between border border-gray-200">
            ...
            <div className="pb-6 border-b border-gray-200/70 min-h-[64px] flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-white border border-gray-200 flex items-center justify-center flex-shrink-0 shadow-xs">
                <Layers className="w-5 h-5 text-nexgen-veryDarkHeader" />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-nexgen-veryDarkHeader">
                Standard FUE
              </h3>
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 flex flex-col justify-between border-2 border-nexgen-primaryGold shadow-xl relative">
            {/* Header */}
            <div className="pb-6 border-b border-gray-200/70 min-h-[64px] flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-nexgen-veryDarkHeader flex items-center justify-center flex-shrink-0 shadow-xs">
                <Sparkles className="w-5 h-5 text-nexgen-brightGold" />
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-nexgen-veryDarkHeader">
            ...
            <div className="divide-y divide-gray-200/70 flex-1 flex flex-col justify-around">
              {COMPARISON_ROWS.map((row, idx) => (
                <div
                  key={idx}
                  className="py-5 sm:py-6 text-sm sm:text-base font-bold text-nexgen-veryDarkHeader flex items-center"
                >
                  {row.qht}
                </div>
              ))}
        ...
        {/* ========================================================
           ...
           ======================================================== */}
        <div className="mt-10 bg-gradient-to-r from-nexgen-mainDarkBg via-nexgen-veryDarkHeader to-nexgen-mainDarkBg rounded-2xl sm:rounded-3xl p-6 sm:py-7 sm:px-10 text-white flex flex-col lg:flex-row items-center justify-between gap-6 shadow-xl border border-nexgen-primaryGold/30">
          ...
          <div className="flex-shrink-0">
            <button
              ...
              className="px-8 py-3.5 rounded-full bg-nexgen-brightGold text-nexgen-veryDarkHeader font-bold text-sm sm:text-base shadow-lg hover:bg-white transition-all transform hover:scale-105 cursor-pointer whitespace-nowrap"
            >
              Consult Now
            </button>
          </div>
